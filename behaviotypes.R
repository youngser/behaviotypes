...
makeFigure1 <- function()
{
    ...
    ggsave(plot=p,"Figure1B.pdf",width=7,height=7)
#    print(p)
}
...
makeFigure2A <- function()
{
    ...
    p <- p + scale_color_manual(values=rep("grey",n))
    ggsave(plot=p,"Figure2A.pdf",width=7,height=7)
#    print(p)
}
...
#    print(pp)
    ggsave(plot=pp,"Figure2C.pdf",width=7,height=7)
...
#    scan()
    ...
    labcol1 <- rev(colorRampPalette(brewer.pal(9,"Reds"))(20))[1:7]
    labcol2 <- rev(colorRampPalette(brewer.pal(9,"Oranges"))(20))[1:7]
    labcol3 <- rev(colorRampPalette(brewer.pal(9,"PuBu"))(20))[1:8]
    labcol4 <- rev(colorRampPalette(brewer.pal(9,"Greens"))(20))[1:7]
...
#    print(p5)
    ggsave(plot=p5,"Figure2F.pdf",width=7,height=7)
...
#    print(p)
    ggsave(plot=p,"Figure2D.pdf",width=7,height=7)
#    scan()
    ...
    ggsave(plot=p,"Figure2E.pdf",width=7,height=7)
#    print(p)
}
...
#    print(p)
    ggsave(plot=p,"Figure3E.pdf",width=7,height=7)
}
...
makeSuppS1toS4 <- function()
{
    ...
    p1 <- clustplot(1:2, 7, 8); ggsave(plot=p1,"FigureSupp1.pdf",width=7,height=7)
    p2 <- clustplot(3:4, 9, 10); ggsave(plot=p2,"FigureSupp2.pdf",width=7,height=7)
    p3 <- clustplot(5:6, 11, 12); ggsave(plot=p3,"FigureSupp3.pdf",width=7,height=7)
    p4 <- clustplot(7:8, 13, 14); ggsave(plot=p4,"FigureSupp4.pdf",width=7,height=7)
}
...
makeSuppS5A <- function()
{
    ...
    p1 <- drawTrial(ctrlname[1]); ggsave(plot=p1,"FigureSupp5A-1.pdf",width=7,height=7)
    p2 <- drawTrial(ctrlname[2]); ggsave(plot=p2,"FigureSupp5A-2.pdf",width=7,height=7)
    p3 <- drawTrial(ctrlname[3]); ggsave(plot=p3,"FigureSupp5A-3.pdf",width=7,height=7)
}
...
makeSuppS5B <- function()
{
    ...
    ggsave(plot=p,"FigureSupp5B.pdf",width=7,height=7)
#    print(p)
}
...
#    print(p2)
    ggsave(plot=p2,"FigureSupp6.pdf",width=7,height=7)    
}
...
#{
    ...
    cat("(Note that some of the figures take long to be generated...)\n")
